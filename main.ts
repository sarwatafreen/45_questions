...
//Task 10
let member:string [] = ['Eric','Cornel','Azhar','sara','saba',];
for(let i=0; i<member.length; i++){
   console.log(member[i])
}

//Task 11
let Member:string [] = ['Ashar','ALI','alzia','sara','usman',];
for(let i=0; i<member.length; i++){
  console.log(member[i])
}

//Task 12
let MemBer: string [] = ['anabiya','Ashar','aliza','Usman','sabail',];
let message_: string = 'Have a nice day! ';
for(let i=0; i<member.length; i++){
  console.log(message_ + MemBer[i]);
}

//Task 13
let tranportation : string [] = ['toyota car', 'honda car','suzuki car',];
for(let i=0; i<tranportation.length; i++){
    console.log('I Would like to own a ' + tranportation[i] + "!" );
}

//Task 14
let GuestList: string [] =['anaya','anas','ali','ahmed',];
GuestList.forEach(oneGuest => console.log( `Asalam u Alaikum ${oneGuest} You are invited for dinner at my home`));

//Task 15
let GUestList: string [] =['anaya','usman','Arsalan','ahmed',];
let notcome = GUestList[0]
console.log(notcome, `: my therepy would be held tommorow so ,I not attend your party, Thanks`)
GUestList.splice(0, 1, "Azhar")
GUestList.forEach(GUEST => console.log( `Asalam u Alaikum ${GUEST} You are invited for dinner at my home`));

//Task 16
let Guest_List: string [] =['anaya','anas','Ureeda','ahmed',];
...
// Task 17
let _GuestList: string [] =['anaya','ahmed','noman','ali',];
...
//Task 18
let places:string[] = ['multan','lahore','rohtas fort','moenjodare','fairy meadows'];
...
let Guestlist: string [] =['anaya','ahmed','ashar','aniqa',];
console.log('printing message indicating number of guest')
console.log(`we had finally invited ${Guestlist} guests in execise 14`)


//Task 20 
let Places:string[]=['multan','lahore','rohtes fort'];
let mountains:string[]=['Kangchenjunga','Annapurna','k2'];
let countries:string[]=['Afghanistan','Albania','Algeria'];
let river:string[]=['Abakan River','Indus River','Dasht River'];
let languages:string[]=['aari','aasax','abaza'];
...
let alien__Color: string = 'yellow';
...
//Task 29
let favorite_fruits: string[] = ['apple', 'banana', 'orange', 'grapes'];
...
//Task 32
let current_users: string[] = ['john', 'alice', 'bob', 'charlie', 'dave'];
let new_users: string[] = ['eric', 'john', 'mike', 'charlie', 'sarah'];
...
//Task 35
let animal :string[]=["dog","cat","donkey"];
...
//Task 40
function makeAlbum(artistName: string, albumTitle: string, tracks?: number): Record<string, any> {
...
//Task 41
let _Magicians:string[]=["Famous Magician","Harry Houdini","David Blaine"];
...
let great_Magicians: string[] = make_Great([...magicians]); // Creating a copy of the original array
...
//Task 45
function storeCarInfo(manufacturer: string, modelName: string, ...extras: [string, any][]): Record<string, any> {
